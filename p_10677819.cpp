...
{ 
 ...
 if(tech[j].fst_name==find)
 {
  ...
  cout<<"Which subject do you teach: "<<tech[j].subj<<endl;
...
for(i=0;choice!='n'&& choice!='N';i++)
{
 ...
 c1<<courseData.cname<<courseData.ccode<<endl;
...
case '2'://editting courses
{ 
ofstream c("course.txt"); 

cout<<"Do you want to change your course Y for Yes or N for No"<<endl;
cin>>ans;

if(ans=='Y'){


cout<<"Type the correct coursename and course code"<<endl;
cin>>courseData.cname>>courseData.ccode;
}
else

cout<<"Recheck to see if your courses are correct"<<endl;


	
 c<<courseData.cname<<courseData.ccode<<endl;
...
case '3':
{ 
ifstream c3("course.txt"); 

cout<<"Do you want to delete your course Y for Yes or N for No"<<endl;
cin>>ans;

if(ans=='Y'){


cout<<"Type the coursename and coursecode you want to delete"<<endl;

cin>>courseData.cname>>courseData.ccode;


cout<<"Are you sure you want to delete or cancel";
cin>>option;


if(option=="delete")
{
	cout<<"Your course has successfully been deleted"<<endl;
}

else
{

cout<<"Deletion of course has failed"<<endl;
}
...
case '4'://Academic Record
{
ofstream a1("AcaRecord.txt"); 
for(int i=0;i<5;i++)
{
...
Access.stdGr[i]= 'F';
 ...
 a1<<Access.stdName<<Access.stdGr<<Access.stdSc<<TotSc<<endl;
